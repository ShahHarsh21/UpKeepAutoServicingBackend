...
var orders = {
    getAllOrder: function (callback) 
    {
        ...
        // select u.*,p.*,o.*,od.* from user_tbl u,product_tbl p,order_tbl o,order_details_tbl od where u.emal_id = o.fk_user_email_id and p.product_id = o.fk_product_id and o.order_id = od.fk_order_id
    },
    getOrderById()
    {
