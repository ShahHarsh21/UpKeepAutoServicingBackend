...
var dash = {
    ...
    ordersCust: function (year, callback) 
    {
        console.log('update data model');
        return db.query('SELECT MONTH(order_date) MONTH, COUNT(*) COUNT FROM order_tbl WHERE YEAR(order_date)=? GROUP BY MONTH(order_date)', [year], callback);
    },
